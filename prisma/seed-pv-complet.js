...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var existingType, newType;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.typePV.findFirst({
                        where: {
                            nom: {
                                contains: 'Complet',
                                mode: 'insensitive'
                ...
                case 1:
                    ...
                    return [4 /*yield*/, prisma.typePV.create({
                            data: {
                ...
                case 2:
                    newType = _a.sent();
                    console.log("Nouveau type de PV cr\u00E9\u00E9 avec l'ID: ".concat(newType.id));
                    return [2 /*return*/];
            }
        });
    });
