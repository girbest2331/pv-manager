// Script pour supprimer le type de PV "PV Bénéficiaire Complet"
const { PrismaClient } = require('@prisma/client');

const prisma = new PrismaClient();

async function main() {
  // Rechercher le type PV avec le nom contenant "Complet"
  ...
  console.log(`Type de PV trouvé: ${typePvToDelete.nom} (ID: ${typePvToDelete.id})`);
