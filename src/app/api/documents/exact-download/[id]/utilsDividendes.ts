...
/**
 * Génère un document DOCX pour PV de répartition de dividendes (structure manuelle, style "exact")
 ...
 * @param gerants Liste des gérants de la société
 */
export async function generateDividendesDocxExact(
  societeInfo: any,
  documentInfo: any,
  ...
  console.log('[DIVIDENDES DOCX] Génération pour documentInfo:', documentInfo);
