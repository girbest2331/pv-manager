/**
 * Template exact pour le PV avec la mise en page correspondant à l'image fournie
 */

export const getExactTemplate = () => {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="page">
    ...
    <div class="section">
      ...
      <!-- Début de la section des associés -->
      <!-- <p class="bold" style="text-align: center;">Les associés présents :</p> -->
      
      {{ASSOCIES_BLOCS}}
      <!-- Fin de la section des associés -->
      ...
      <p>Monsieur/Madame, <span class="red">{{PRESIDENT_NOM}}</span> préside l'assemblée préside l'assemblée :</p>
  ...
  <div class="page">
    ...
    <div style="margin-left: 30px;">
      <ul style="list-style-type: disc;">
        <li><strong>Affectation des résultats de l'exercice</strong> (<span class="red">{{EXERCICE}}</span>)</li>
      </ul>
    </div>
    
    <p>L'assemblée générale décide d'affecter le résultat bénéficiaire soit :
      <span class="red">{{MONTANT_RESULTAT_MOINS_AFFECTATIONS}}</span> DHS au report à nouveau
      et <span class="red">{{MONTANT_AFFECTE_RESERVE_STATUTAIRE}}</span> DHS à la Réserve légale statutaire
      et <span class="red">{{MONTANT_AFFECTE_RESERVE_FACULTATIVE}}</span> DHS à la Réserve légale facultative.
    </p>
    <p>La nouvelle situation deviendra comme suit</p>
    <p><strong>** Report à nouveau :</strong>  <span class="red">{{REPORT_A_NOUVEAU_FINAL}}</span> DHS</p>
    <p><strong>** Réserve légale statutaire :</strong>  <span class="red">{{RESERVE_LEGALE_STATUTAIRE_FINAL}}</span> DHS</p>
    <p><strong>** Réserve facultative :</strong>  <span class="red">{{RESERVE_FACULTATIVE_FINAL}}</span> DHS</p>
