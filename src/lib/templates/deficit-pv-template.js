/**
 * Template pour le PV d'affectation de résultats déficitaires (identique à exact-pv-template
 * sauf que dans TROISIÈME RÉSOLUTION, on remplace "bénéficiaire" par "déficitaire")
 */

export const getDeficitTemplate = () => {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
...
<body>
  ...
  <div class="page">
    ...
    <p>L'assemblée générale décide d'affecter le résultat <strong>déficitaire</strong> soit :
