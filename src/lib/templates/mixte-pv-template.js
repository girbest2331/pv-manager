/**
 * Template PV mixte (affectation de résultats déficitaires et répartition de dividendes)
 * Combinant les fonctionnalités des deux types de PV
 */

export const getMixteTemplate = () => {
  return `<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
  <title>PV Mixte (Affectation de résultats déficitaires et répartition de dividendes)</title>
  <style>
    @page {
      size: A4;
